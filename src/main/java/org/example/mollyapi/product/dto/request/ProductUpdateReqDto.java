...
public record ProductUpdateReqDto(
    ...
    static public ProductDto from(ProductUpdateReqDto updateReqDto) {
        return new ProductDto(
                null,
                updateReqDto.categories(),
                updateReqDto.brandName(),
                updateReqDto.productName(),
                updateReqDto.price(),
                updateReqDto.description()
        );
    }
}
